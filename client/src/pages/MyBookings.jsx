    ...
    <div className='py-28 md:py-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking)=>(
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] items-center w-full border-b border-gray-300 py-4 first:border-t'>
                {/* Hotel Details */}
                ...
                {/* payment status */}
                <div className='flex flex-col items-center justify-center md:justify-center text-center h-full'>
