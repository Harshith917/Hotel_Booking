    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
          <p>Guests will be allocated on the ground floor based on availability. You’ll enjoy a comfortable two-bedroom apartment with a true city vibe. The quoted price is for two guests; please select the correct number of guests at checkout to get the exact price for larger groups.</p>
        </div>
...
{/* Posted by */}
        ...
        <div className='flex flex-col items-start gap-4'>
          ...
          <button className='px-6 py-2 mt-4 rounded text-white bg-primary hover:bg-primary-dull transitio-all cursor-pointer'>Contact Now</button>
