...
const AllRooms = () => {
    ...
    const priceRanges = ["0 - 500", "500 - 2000", "2000 - 3000"];
    const sortOptions = ["Price Low to High", "Price to Low", "Newest First"];
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 1g:px-24 x1:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Make the most of limited-time offers and special packages to elevate your stay and craft memories that last.</p>
            </div>
            ...
            {roomsDummyData.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p onClick={()=> {navigate(`/rooms/${room._id}`); scrollTo(0,0)}} className='text-gray-800'>{room.hotel.name}</p>
